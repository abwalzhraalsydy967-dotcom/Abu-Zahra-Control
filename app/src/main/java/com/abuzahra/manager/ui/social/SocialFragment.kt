package com.abuzahra.manager.ui.social
...
class SocialFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return try {
            ...
            createErrorView("خطأ في تحميل التطبيقات")
        }
    }
    ...
    private fun buildView(): View {
        ...
        // Title
        val title = ViewUtils.createTitleText(ctx, "التطبيقات الاجتماعية", 20f, ColorPalette.TEXT_PRIMARY)

        // Subtitle
        val subtitle = ViewUtils.createSubtitleText(
            ctx, "الوصول إلى محادثات وبيانات التطبيقات الاجتماعية",
            13f, ColorPalette.TEXT_HINT
        ).apply {
    ...
    private fun setupActions() {
        try {
            val actions = commandRepository.getSocialAppActions()
