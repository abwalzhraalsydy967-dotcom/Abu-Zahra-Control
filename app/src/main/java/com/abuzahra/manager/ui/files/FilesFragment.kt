package com.abuzahra.manager.ui.files
...
class FilesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return try {
            ...
            createErrorView("خطأ في تحميل الملفات")
        }
    }
    ...
    private fun buildView(): View {
        ...
        // Title
        val title = ViewUtils.createTitleText(ctx, "الملفات والوسائط", 20f, ColorPalette.TEXT_PRIMARY)
