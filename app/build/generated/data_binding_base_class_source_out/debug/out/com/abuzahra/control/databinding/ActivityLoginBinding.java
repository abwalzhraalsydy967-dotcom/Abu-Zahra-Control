...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextView tvGoRegister, @NonNull TextView tvOr, @NonNull TextView tvSubtitle,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnGoogleSignIn, btnLogin, etEmail,
          etPassword, ivLogo, tilEmail, tilPassword, tvForgotPassword, tvGoRegister, tvOr,
          tvSubtitle, tvTitle);
    }
